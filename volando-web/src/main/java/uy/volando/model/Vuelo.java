...
public class Vuelo {
    ...
    public Vuelo(String nombre, LocalDate fecha, LocalTime duracion, int maxTuristas, int maxEjecutivos, String urlImage, LocalDate fechaAlta, RutaDeVuelo rutaDeVuelo, int cantReservas) {
        this.nombre = nombre;
        this.fecha = fecha;
    ...
    public Vuelo(DtVuelo dtVuelo) {
        this.nombre = dtVuelo.getNombre();
        this.fecha = dtVuelo.getFecha();
        this.duracion = dtVuelo.getDuracion();
        this.maxTuristas = dtVuelo.getMaxTuristas();
        this.maxEjecutivos = dtVuelo.getMaxEjecutivos();
        this.urlImage = dtVuelo.getUrlImage();
        this.fechaAlta = dtVuelo.getFechaAlta();
        this.rutaDeVuelo = new RutaDeVuelo(dtVuelo.getRutaDeVuelo().getDatos());
        this.cantReservas = dtVuelo.getCantReservas();
    }
