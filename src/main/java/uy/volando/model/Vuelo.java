...
public class Vuelo {
    ...
    public Vuelo(String nombre, LocalDate fecha, int duracion, int maxTuristas, int maxEjecutivos, String urlImage,LocalDate fechaAlta,RutaDeVuelo rutaDeVuelo, int cantReservas) {
        this.nombre = nombre;
        this.fecha = fecha;
